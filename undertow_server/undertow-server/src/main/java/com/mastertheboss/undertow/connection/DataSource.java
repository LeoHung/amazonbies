...
public class DataSource {
    ...
    public DataSource(String ip, String username, String password, String dbname) throws IOException, SQLException, PropertyVetoException {
    ...
    // public void init(String ip, String username, String password, String dbname ) throws Exception {
